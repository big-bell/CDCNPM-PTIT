...

{
    ...
    {
        //private readonly IWebHostEnviroment _webHost;
        ...
        public ActionResult Create([Bind(Include = "MaSP,TenSP,GiaBan,Soluong,MoTa,MaLoai,MaNCC,AnhSP")] SanPham sanPham, HttpPostedFileBase AnhSP)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaSP,TenSP,GiaBan,Soluong,MoTa,MaLoai,MaNCC,AnhSP")] SanPham sanPham, HttpPostedFileBase AnhSP)
        {
            if (ModelState.IsValid)
            {
                if (AnhSP != null && AnhSP.ContentLength > 0)
